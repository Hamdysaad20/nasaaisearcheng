...
function  FullDisplay(props) {
  return (
    <div style={{ fontFamily: "Poppins-Bold , SfproText" , width: "400" }}  className=" max-w-[1380px] overflow-hidden overflow-y-auto  md:pt-28 md:ml-36 h-screen pt-[160px] px-1 duration-500  z-40 absolute top-0 backdrop-blur-md bg-gray-900/20 w-full  ">
